...
out_w = model.out.weight.data.detach().numpy()
out_b = model.out.bias.data.detach().numpy()
...
np.savetxt("csv_dumps/float_orig/out_w.csv", out_w, delimiter=",")
np.savetxt("csv_dumps/float_orig/out_b.csv", out_b, delimiter=",")
...
np.savetxt("csv_dumps/scaled_int/out_w.csv", (w_scale * out_w).astype(int), fmt='%i', delimiter=",")
np.savetxt("csv_dumps/scaled_int/out_b.csv", (b_scale * out_b).astype(int), fmt='%i', delimiter=",")
